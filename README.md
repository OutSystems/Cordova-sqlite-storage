...
SQLite cordova interface based on (the now gone) *storage-master* branch of [storesafe/cordova-sqlite-storage](https://github.com/storesafe/cordova-sqlite-storage) customized to provide:
